  ...
  return (
    <div className={styles.soWrapper}>
      ...
      <div className="content-container ">
        ...
        <main>
          <h2>Updates (Late 2025)</h2>
          <p className="u-mb-10">
            The project has been migrated to{' '}
            <a href="https://analogjs.org/" rel="noreferrer" target="_blank">
              AnalogJS
            </a>{' '}
            to leverage Angular’s Static Site Generation (SSG) capabilities. Several minor UX improvements were
            implemented, including the addition of sound effects to enhance interactivity.
          </p>
          <br></br>
